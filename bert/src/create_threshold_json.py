...
#python src/create_threshold_json.py ../data/dev.json ./model_state/ckpt.2.pkl
def eval(model, dataloader, answerable_threshold):
...
if __name__ == '__main__':
    ...
    for threshold in answerable_threshold:
        pred = eval(model, testloader, threshold)
        output_file = open('./threshold/predict/'+str(threshold)+'_predict.json', 'w')       
